"""Tournament competition composition root (V1.5.83).
...
def register_routes(context):
    ...
    # V1.5.83: the legacy monolith allowed functions in any section to resolve
    # helpers/constants declared later in the same module. After V1.5.83 split,
