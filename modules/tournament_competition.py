"""Tournament competition composition root (V1.5.82).
...
def register_routes(context):
    ...
    # V1.5.82: the legacy monolith allowed functions in any section to resolve
    # helpers/constants declared later in the same module. After V1.5.82 split,
