    ...
    def room_confirm_result(room_id):
        ...
        try:
            ...
            if fresh_match and fresh_match.get("status") == "confirmed":
                ...
                flash("Kết quả đã được ghi nhận. Hãy tải lại phòng để cập nhật trạng thái.", "warning")
            else:
            ...
            if fresh_match and fresh_match.get("status") == "confirmed":
                ...
                flash("Chưa thể hoàn tất xác nhận kết quả. Hãy tải lại phòng và thử lại.", "danger")
            return redirect(url_for("room_detail", room_id=room_id))
